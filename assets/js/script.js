var athletesArray = ["Stephen Curry", "Clay Thompson", "Draymond Green", "Steve Kurr", "Lebron James"];
...
function searchGif(gifName) {
    $.ajax({
        url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + ' &api_key=6pvZD9hO9ZHGAexTfrB680EJjROQ5BGn',
        type: 'GET',
    })
